...
- Minted with USDT (minus a small minting fee)
...
2. **Mint OCUSD** (you receive OCUSD at current share price, minus the minting fee)
...
- Receive OCUSD at current share price
