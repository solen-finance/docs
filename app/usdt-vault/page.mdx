...
|---------------------|----------------|--------------|----------------|---------------|--------------------|-------------|
| USDX (Stables Labs) | USDX           | 11.53%       | –              | 11.53%        | 8.26%              | $13.32M     |
| Ethena sUSDe        | USDe           | N/A          | 8.20%          | 8.20%         | N/A                | N/A         |
| Harmonix Finance    | USDC           | 19.18%       | –              | 19.18%        | 16.80%             | $5.37M      |
...
| **Protocol** | **Stablecoin** | **Base APY** | **Reward APY** | **Total APY** | **30-Day Avg APY** | **TVL**     |
|--------------|----------------|--------------|----------------|---------------|--------------------|-------------|
| Beefy (MIM-USDC) | MIM-USDC    | 10.34%       | –              | 10.34%        | 12.14%             | $4.92M      |
| Beefy (MIM-USDT) | MIM-USDT    | 10.57%       | –              | 10.57%        | 12.82%             | $2.35M      |
